...
import com.example.schooldetailapidemo.ui.repository.TeacherDetailRepository
...
class TeacherDetailViewModel @Inject constructor() : ViewModel() {
    ...
    @Inject
    lateinit var teacherDetailRepository: TeacherDetailRepository

    private var responseCodeCheck: ResponseCodeCheck = ResponseCodeCheck()
    private var mutabableLiveData: MutableLiveData<Resource<TeacherDetailRoot>> = MutableLiveData()
    var liveData: LiveData<Resource<TeacherDetailRoot>> = mutabableLiveData

    fun getTeacherDetailData(id: String) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                val mainRepository: Response<TeacherDetailRoot> =
                    teacherDetailRepository.getTeacherDetailData(hashMap)
